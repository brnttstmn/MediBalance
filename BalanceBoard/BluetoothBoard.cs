...
namespace BalanceBoard
{
    class BluetoothBoard
    {
            ...
            try
            {
                using (var btClient = new BluetoothClient())
                {
                    ...
                    foreach (var btItem in btDiscoveredList)
                    {
                        ...
                        if (false)//checkBox_PermanentSync.Checked
                        {
                    ...
                    Console.WriteLine("Finished - You can now close this window. Found: " + btDiscoveredList.Length + " Ignored: " + btIgnored);
                }
            }
            catch (Exception ex)
            {
        ...
        private static string AddressToWiiPin(string bluetoothAddress)
        {
