...
namespace MediBalance.Classes.WiiBalanceBoard
{
    ...
    public class ActionItem
    {
        ...
        System.Threading.Timer inputTimer = new System.Timers.Timer() { Interval = 2, Enabled = false };
        private string v;
        private ComboBox comboBox_AL;
        private NumericUpDown numericUpDown_AL;
        ...
        public ActionItem(string v, ComboBox comboBox_AL, NumericUpDown numericUpDown_AL)
        {
            this.v = v;
            this.comboBox_AL = comboBox_AL;
            this.numericUpDown_AL = numericUpDown_AL;
        }
