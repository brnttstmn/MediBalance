...
using MediBalance.Classes.WiiBalanceBoard;
using System;
...
namespace WiiBalanceWalker
{
    public partial class FormMain : Form
    {
        ...
        private void label_rwWT_Click(object sender, EventArgs e)
        {
            
        }

        private void label_brDF_Click(object sender, EventArgs e)
        {

        }

        private void groupBox_Actions_Enter(object sender, EventArgs e)
        {

        }

        private void groupBox_OffsetWeightRatio_Enter(object sender, EventArgs e)
        {
        ...
        private void groupBox_BalanceRatio_Enter(object sender, EventArgs e)
        {

        }

        private void label_brX_Click(object sender, EventArgs e)
        {
